...
def load_obras():
    if os.path.exists("data/obras.csv"):
        ...
        obras = [
            {"id": 1, "titulo": "", "": "", "": "", 
             "imagem": r"D:\Validador\folksonomia\BC.000153.jpg"},
            {"id": 2, "titulo": "A Noite Estrelada", "artista": "Vincent van Gogh", "ano": "1889", 
             "imagem": r"D:\Validador\folksonomia\BC.000164.1.JPG"},
            {"id": 3, "titulo": "Guernica", "artista": "Pablo Picasso", "ano": "1937", 
             "imagem": r"D:\Validador\folksonomia\BC000046_1_15-08-2024.jpg"},
        ]
